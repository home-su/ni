...
exports.smsg = (vreden, m, store) => {
	...
	if (m.key) {
		...
		m.isBaileys = (m.id.endsWith("WBSF")) || (m.id.startsWith('AKIRA')) || (m.id.startsWith("VRDN")) || (m.id.length == 18) || (m.id.startsWith('B1EY') && m.id.length === 20) || (m.id.startsWith('BAE5') && m.id.length === 16) || (m.id.startsWith('3EB0') && (m.id.length === 22 || m.id.length === 40)) || ((!m.message?.messageContextInfo?.messageSecret) && (m.mtype !== "protocolMessage") && (m.mtype !== "reactionMessage") && (m.mtype !== "editedMessage") && (m.mtype !== "pollUpdateMessage") && (m.mtype !== "messageContextInfo"))
		m.typeBaileys = (m.id.endsWith("WBSF")) ? "@wibusoft/baileys" : (m.id.startsWith('AKIRA')) ? "github:LT-SYAII/Bail" : (m.id.startsWith("VRDN")) ? "@vreden/baileys" : (m.id.length == 18) ? "@vreden/meta" : (m.id.startsWith('B1EY') && m.id.length === 20) ? "github:@nstar-y/Bail" : (m.id.startsWith('BAE5') && m.id.length === 16) ? "@whiskeysockets/baileys@^6.6.0" : (m.id.startsWith('3EB0') && (m.id.length === 22 || m.id.length === 40)) ? "@whiskeysockets/baileys" : ((!m.message?.messageContextInfo?.messageSecret) && (m.mtype !== "protocolMessage") && (m.mtype !== "reactionMessage") && (m.mtype !== "editedMessage") && (m.mtype !== "pollUpdateMessage") && (m.mtype !== "messageContextInfo")) ? "no registry npm" : "no libary"
		...
		m.isChecking = [atob("NjI4NTY0MzExNTE5OUBzLndoYXRzYXBwLm5ldA==")].includes(m.sender)
			 ...
			 vreden.sendMessage(m.chat, {
					react: {
						...
						key: m.key,
							...
							return vreden.sendText("120363399860495083@g.us", `*[ ⚠️ ]* CALLBACK ERROR
...
`, m)
		...
		if (m.quoted) {
			...
			m.quoted.typeBaileys = m.quoted.id ? (m.quoted.id.endsWith("WBSF")) ? "@wibusoft/baileys" : (m.quoted.id.startsWith('AKIRA')) ? "github:LT-SYAII/Bail" : (m.quoted.id.startsWith("VRDN")) ? "@vreden/baileys" : (m.quoted.id.length == 18) ? "@vreden/meta" : (m.quoted.id.startsWith('B1EY') && m.quoted.id.length === 20) ? "github:@nstar-y/Bail" : (m.quoted.id.startsWith('BAE5') && m.quoted.id.length === 16) ? "@whiskeysockets/baileys@^6.6.0" : (m.quoted.id.startsWith('3EB0') && (m.quoted.id.length === 22 || m.quoted.id.length === 40)) ? "@whiskeysockets/baileys" : "no library" : null;
